...
LICENSE_URL = f"https://huggingface.co/{MODEL_ID}/blob/main/LICENSE"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Fetch the pinned Qwen 1.5B baseline into D: project storage.")
    ...
    payload = {
        "artifact_version": "qwen2_5_1_5b_instruct_v1",
        "model_id": MODEL_ID,
        "revision": revision,
        "license": "Apache-2.0",
